...
const Hero: FC = () => {
  return (
    <div className="py-12 mb-4 border-b bg-hero dark:border-b-gray-700/80 bg-gradient-to-r from-cyan-200 to-blue-300">
        ...
        <div className="flex items-stretch py-8 w-full text-center sm:py-12 sm:text-left">
          <div className="flex-1 flex-shrink-0 space-y-3">
            ...
            <div className="leading-7 text-gray-700">
              {APP_NAME} is a decentralized, and permissionless blogging app
